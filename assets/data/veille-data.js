  ...
  "topics": {
    ...
    "intelligence-artificielle": {
      ...
      "entries": [
        {
          "date": "15 août 2026",
          "title": "ChatGPT affichera des publicités en France dès la fin du mois",
          "source": "01net",
          "url": "https://www.01net.com/actualites/chatgpt-affichera-des-publicites-en-france-des-la-fin-du-mois.html",
          "summary": "Fini le tête-à-tête : vos conversations avec ChatGPT accueilleront bientôt un troisième participant, l'annonceur. OpenAI a prévenu ses utilisateurs européens, la publicité arrive fin août.",
          "interest": "Cette publication alimente ma veille IA car elle montre un usage, un risque ou un impact professionnel lié à l'intelligence artificielle."
        },
        {
          "date": "14 août 2026",
          "title": "Le ChatGPT le plus intelligent peut maintenant répondre 14 fois plus vite : à quoi ça sert ?",
          "source": "01net",
          "url": "https://www.01net.com/actualites/le-chatgpt-le-plus-intelligent-peut-maintenant-repondre-14-fois-plus-vite-a-quoi-ca-sert.html",
          "summary": "Le modèle le plus intelligent d'OpenAI vient de gagner un mode turbo. Sauf qu'il n'arrivera pas dans ChatGPT, qu'aucun tarif n'a été annoncé, et qu'une poignée d'entreprises seulement y ont accès.",
          "interest": "Cette publication alimente ma veille IA car elle montre un usage, un risque ou un impact professionnel lié à l'intelligence artificielle."
        },
        {
          "date": "29 juillet 2026",
        ...
        {
          "date": "15 août 2026",
          "title": "Gemini 3.7 Flash : Google délaisse les modèles de pointe pour affronter les IA chinoises sur le prix",
          "source": "01net",
          "url": "https://www.01net.com/actualites/gemini-3-7-flash-google-delaisse-les-modeles-de-pointe-pour-affronter-les-ia-chinoises-sur-le-prix.html",
          "summary": "Trois semaines après le précédent, Google sort un nouveau modèle et divise son tarif par deux. Son modèle de pointe, lui, se fait toujours attendre depuis le mois de mai.",
          "interest": "Cette publication alimente ma veille IA car elle montre un usage, un risque ou un impact professionnel lié à l'intelligence artificielle."
        }
      ]
    }
